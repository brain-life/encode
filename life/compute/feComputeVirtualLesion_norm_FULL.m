...
predicted_woVL = feGet(fe, 'pred full');
predicted_woVL = predicted_woVL(:,voxel_ind);
...
predicted_VL = feGet(fe,'pred lesion with iso',ind_tract);
predicted_VL = predicted_VL(:,voxel_ind);
