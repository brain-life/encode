...
if Compute_matrix_M
    Mmatrix = [];
    feaux = feConnectomeBuildModel_Large(fe,Compute_matrix_M,1,100000);
    Mmatrix = [Mmatrix, feaux.life.M.Mmatrix];
    disp('BLOCK 1 built')
    feaux = feConnectomeBuildModel_Large(fe,Compute_matrix_M,100001,200000);
    Mmatrix = [Mmatrix, feaux.life.M.Mmatrix];
    disp('BLOCK 2 built')
    feaux = feConnectomeBuildModel_Large(fe,Compute_matrix_M,200001,300000);
    Mmatrix = [Mmatrix, feaux.life.M.Mmatrix];
    disp('BLOCK 3 built')
    feaux = feConnectomeBuildModel_Large(fe,Compute_matrix_M,300001,400000);
    Mmatrix = [Mmatrix, feaux.life.M.Mmatrix];
    disp('BLOCK 4 built')
    feaux = feConnectomeBuildModel_Large(fe,Compute_matrix_M,400001,500000);
    Mmatrix = [Mmatrix, feaux.life.M.Mmatrix];
    disp('BLOCK 5 built')
    
    fe = feConnectomeBuildModel(fe,0);
