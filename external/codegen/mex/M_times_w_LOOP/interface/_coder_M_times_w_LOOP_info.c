...
/* Include files */
#include "_coder_M_times_w_LOOP_info.h"
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/N/dc2/projects/lifebid/code/lifebid/external/M_times_w_LOOP.m"),
                "context", 0);
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1412177604U), "fileTimeLo", 0);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                "resolved", 2);
  emlrtAddField(*info, b_emlrt_marshallOut(1395935456U), "fileTimeLo", 2);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("M_times_w_LOOP"));
...
/* End of code generation (_coder_M_times_w_LOOP_info.c) */
